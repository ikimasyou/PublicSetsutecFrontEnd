<template>
    <div class="menu-text" @click="extendSubMenu" ref="dropdownButton" @mousemove="barMouseMoveHandler(0)" @mouseleave="barMouseLeaveHandler(0)">  
    ...
    <div class="menu-text" @click="toSkillSubmit" @mousemove="barMouseMoveHandler(1)" @mouseleave="barMouseLeaveHandler(1)" > スキル登録 </div>
    ...
    <div class="menu-text" @click="toSendMessage" @mousemove="barMouseMoveHandler(2)" @mouseleave="barMouseLeaveHandler(2)"> 勤務への連絡 </div>
    <div class="menu-text" @click="toTransportationFeeList" @mousemove="barMouseMoveHandler(3)" @mouseleave="barMouseLeaveHandler(3)"> 交通費 </div>
